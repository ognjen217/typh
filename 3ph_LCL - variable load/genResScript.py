...
@pytest.fixture(scope="module", params=Vs1_values)
def _Vs1_values(request):    
    return request.param
...
def setup_control(_C_values, _L_values, _Lg_values, _Vin_values, _Vs1_values):    
    ...
    model.set_component_property("Vs1", "init_rms_value"      , Vs1)
...
def test_rectifier(setup_control):
    ...
    data_file_name = f"./3ph_inv_L={L:.0e}_C={C:.0e}_Lg={Lg:.0e}_V={Vin:.0e}_Vs1={Vs1:.0e}.csv"

    # Start capturing additional signals
    capture.start_capture(duration=0.05, signals=['Ia', 'Ib', 'Ic', 
                            'Inv1.Phase A.PWM_Modulator.TOP_1', 
                            'Inv1.Phase B.PWM_Modulator.TOP_1', 
                            'Inv1.Phase C.PWM_Modulator.TOP_1', 
                            'Inv1.Phase A.PWM_Modulator.BOT_1', 
                            'Inv1.Phase B.PWM_Modulator.BOT_1', 
                            'Inv1.Phase C.PWM_Modulator.BOT_1',
                            'Va1', "Vb1", "Vc1"
